...
- **Deuda de producción abierta** (tabla completa con cifras en `command-prompts/codebase-architecture-protocol.md`), por orden de gravedad:
  ...
  7. **Assets pendientes:** `Hero_02.mp4` = 6.17 MB (es el LCP), los 28 vídeos sin `poster`, y 11 JPEG sobre-codificados (6.5 MB → ~690 kb en WebP q82, ya medido). Sin imagen de OG (1200×630) los previews salen sin miniatura.
