...
- **Status Visual:** Hero 100% diagramado, responsivo (con fix de WebKit para bordes curvos de video) y sincronizado. Pendiente ejecutar la "Purga" para estandarizar código.
