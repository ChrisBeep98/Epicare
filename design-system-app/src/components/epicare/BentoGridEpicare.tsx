    ...
    <svg className={className} viewBox="0 0 192 73" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_2170_4296)">
        <g clipPath="url(#clip1_2170_4296)">
          <path d="M130.622 56.9801H134.354L132.492 51.5981L130.622 56.9801Z" fill="#35BBFD"/>
    ...
    <svg className={className} viewBox="0 0 192 73" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_2170_4318)">
        <g clipPath="url(#clip1_2170_4318)">
          <path d="M178.61 49.46C178.61 46.3 176.048 43.738 172.888 43.738H118.536C116.258 53.58 109.45 61.698 100.43 65.774H178.61V49.46Z" fill="#35BBFD"/>
